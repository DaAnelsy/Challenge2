...
import ConversorMonedas.ConvertMoney;
import ConversorTemperatura.ConvertTemperatura;

public class Ejecucion {
	 public static void main (String[] args) {

	        ConvertMoney monedas = new ConvertMoney();
	        ConvertTemperatura temperatura = new ConvertTemperatura();
	        boolean inicio=true;    
	        while(inicio) {
